      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center justify-center text-center mb-16 md:mb-20">
          <img
            ...
            height="639"
          />
          <p className="font-serif text-sm md:text-base text-ink-600">
            一人じゃない。あなたの人生は、もっと自由にデザインできる。
          </p>
          <p className="font-script text-2xl text-brand-500 mt-4">Design your life.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-ink/10 pt-12">
          <div className="col-span-1 md:col-span-2">
            <img
              ...
              height="477"
            />
            <p className="text-sm text-ink-600 leading-[2] max-w-sm">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-5 text-sm text-ink-600 hover:text-ink transition-colors"
            >
          ...
          <div>
            <p className="font-display tracking-[0.25em] uppercase mb-5 text-brand-700 text-sm">メニュー</p>
          ...
          <div>
            <p className="font-display tracking-[0.25em] uppercase mb-5 text-brand-700 text-sm">規約</p>
            <ul className="space-y-2.5 text-sm text-ink-600">
              <li>
