...
const voices = [
  { text: '夫を支えながら、自分の仕事や人生も、大切にしたい。', tag: 'アスリートを支える妻・30代' },
  { text: '気づけば、自分のやりたいことをずっと後回しにしていました。', tag: 'アスリートを支える妻・30代' },
  { text: '“支えるだけ”じゃなく、一緒に挑戦する関係になりたい。', tag: 'アスリートを支える妻・20代' },
  { text: '同じ環境の人と話せる。それだけで、また前を向ける気がします。', tag: 'アスリートを支える妻・40代' },
];
