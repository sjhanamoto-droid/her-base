      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <AnimatedSection direction="left" delay={0.3} className="lg:col-span-6">
            <p className="font-display tracking-[0.35em] text-brand-700 text-sm mb-6 uppercase">Message</p>
            <h3 className="font-serif text-3xl md:text-4xl font-semibold leading-[1.7] tracking-[0.06em] text-ink mb-9">
              支える側から、<br />挑戦する側へ。
            </h3>
            <div className="space-y-6 text-ink-600 leading-[2.1] text-[0.95rem] md:text-base">
              <p>
              ...
              <p className="text-ink font-medium border-l border-brand-500 pl-6 py-1 leading-[2]">
